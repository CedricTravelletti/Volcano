...
class SquaredExponentialKernel:
    """ Squared exponential covariance module.
    ...
    cells_coords: Tensor
        List of fixed model points. Dimension n_cells * n_dims.

    """
    def __init__(self, lambda0, cells_coords):
        ...
        self.lambda0 = lambda0.type(dtype)
        self.cells_coords = cells_coords.type(dtype)

        self.cells_coords.requires_grad = True
