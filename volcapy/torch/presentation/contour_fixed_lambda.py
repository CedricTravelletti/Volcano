...
for epoch in range(100000):
    ...
    test_rmses.append(test_error.item())
...
np.save("log_likelihoods_train.npy", np.array(lls))
np.save("train_rmses_train.npy", np.array(train_rmses))
np.save("test_rmses_train.npy", np.array(test_rmses))
np.save("m0s_train.npy", np.array(m0s))
np.save("sigma0s_train.npy", np.array(sigma0s))
np.save("lambda0s_train.npy", np.array(lambda0s))
